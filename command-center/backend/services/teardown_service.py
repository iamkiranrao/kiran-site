...
{{
  ...
  "journey_sentiment_svg": "<svg viewBox=\\"0 0 500 130\\" fill=\\"none\\" xmlns=\\"http://www.w3.org/2000/svg\\" aria-label=\\"Customer sentiment map...\\"><title>Customer Journey Sentiment Map - PRODUCT</title><!-- 3 reference lines at y=20,55,90 --><line x1=\\"50\\" y1=\\"20\\" x2=\\"460\\" y2=\\"20\\" stroke=\\"var(--border)\\" stroke-width=\\"0.5\\" opacity=\\"0.3\\"/>...<!-- Y-axis labels at x=8: Optimistic(y=23), Neutral(y=58), Frustrated(y=93) font-size=7 fill=var(--text-muted) --><!-- Cubic bezier path through all data points, stroke=var(--text-secondary) stroke-width=2 opacity=0.4 --><!-- Area fill path (same + close to y=105) fill=var(--text-secondary) opacity=0.04 --><!-- Circle data points r=6: green #6b9e6b positive, red #c47474 negative, amber #d4a74a neutral --><!-- Sentiment labels font-size=7 positioned above dots (y = dot_cy - 12), color matches dot --><!-- Stage labels at y=120 font-size=7 uppercase font-weight=600 letter-spacing=0.5 text-anchor=middle --></svg>",
